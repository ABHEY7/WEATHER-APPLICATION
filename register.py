...
#title
       ...
       #center
        ...
        self.pas1=Entry(mainframe,width=12,font=('arial',30),bd=2)
        self.pas1.place(x=400,y=120)
        self.pas2=Entry(mainframe,width=12,font=('arial',30),bd=2)
       ...
       #lables
        ...
        self.pasword.place(x=300,y=335)
        self.root.mainloop()
